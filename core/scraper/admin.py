...
class OjccCaseAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ["case_id","case_yr","case_num","ojcc_case_number","judge","mediator","carrier","accident_date","date_assigned","district","county","counsel_for_claimant","counsel_for_employer"]
    inlines = [
    ScheduleInline,
    DocketInline
        ]
